...
namespace Presentacion {
    ...
    public partial class SIGVADataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuariosRow AddUsuariosRow(int Cedula, string Nombre, string Apellido1, string Apellido2, string Usuario, string Clave, int Rol) {
...
namespace Presentacion.SIGVADataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([Cedula] = @Original_Cedula) AND ([Nombre] = @Original_Nombre) AND ([Apellido1] = @Original_Apellido1) AND ([Apellido2] = @Original_Apellido2) AND ([Usuario] = @Original_Usuario) AND ([Clave] = @Original_Clave) AND ([Rol] = @Original_Rol))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Usuarios] ([Cedula], [Nombre], [Apellido1], [Apellido2], [Usuario], [Clave], [Rol]) VALUES (@Cedula, @Nombre, @Apellido1, @Apellido2, @Usuario, @Clave, @Rol);
SELECT Cedula, Nombre, Apellido1, Apellido2, Usuario, Clave, Rol FROM Usuarios WHERE (Usuario = @Usuario)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [Cedula] = @Cedula, [Nombre] = @Nombre, [Apellido1] = @Apellido1, [Apellido2] = @Apellido2, [Usuario] = @Usuario, [Clave] = @Clave, [Rol] = @Rol WHERE (([Cedula] = @Original_Cedula) AND ([Nombre] = @Original_Nombre) AND ([Apellido1] = @Original_Apellido1) AND ([Apellido2] = @Original_Apellido2) AND ([Usuario] = @Original_Usuario) AND ([Clave] = @Original_Clave) AND ([Rol] = @Original_Rol));
SELECT Cedula, Nombre, Apellido1, Apellido2, Usuario, Clave, Rol FROM Usuarios WHERE (Usuario = @Usuario)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Cedula, Nombre, Apellido1, Apellido2, Usuario, Clave, Rol FROM dbo.Usuario" +
                "s";
        ...
        public virtual int Fill(SIGVADataSet.UsuariosDataTable dataTable) {
        ...
        public virtual SIGVADataSet.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SIGVADataSet.UsuariosDataTable dataTable = new SIGVADataSet.UsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SIGVADataSet.UsuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Cedula, string Original_Nombre, string Original_Apellido1, string Original_Apellido2, string Original_Usuario, string Original_Clave, int Original_Rol) {
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_Rol));
        ...
        public virtual int Insert(int Cedula, string Nombre, string Apellido1, string Apellido2, string Usuario, string Clave, int Rol) {
        ...
        public virtual int Update(int Cedula, string Nombre, string Apellido1, string Apellido2, string Usuario, string Clave, int Rol, int Original_Cedula, string Original_Nombre, string Original_Apellido1, string Original_Apellido2, string Original_Usuario, string Original_Clave, int Original_Rol) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Cedula, string Nombre, string Apellido1, string Apellido2, string Clave, int Rol, int Original_Cedula, string Original_Nombre, string Original_Apellido1, string Original_Apellido2, string Original_Usuario, string Original_Clave, int Original_Rol) {
            return this.Update(Cedula, Nombre, Apellido1, Apellido2, Original_Usuario, Clave, Rol, Original_Cedula, Original_Nombre, Original_Apellido1, Original_Apellido2, Original_Usuario, Original_Clave, Original_Rol);
        }
    }
